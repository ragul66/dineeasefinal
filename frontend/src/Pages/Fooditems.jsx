...
//   // Handle file change for food photo
//   const handleFileChange = (e) => {
//     setFoodPhoto(e.target.files[0]);
//   };
...
//         setFoodData({ foodname: "", description: "", price: "", timing: "" });
//         setFoodPhoto(null);
//       } else {
//         console.error("Failed to add food item");
//       }
...
//         <button
//           type="submit"
//           className="mt-4 bg-orange-400 text-white py-2 px-4 rounded-md hover:bg-blue-600"
//         >
//           <IoAddOutline className="flex" />
//           Add Food Item
//         </button>
//       </form>
